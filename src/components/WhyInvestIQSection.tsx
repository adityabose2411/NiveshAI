...
const WhyHundiAISection = () => {
  const benefits = [
    { icon: Bot, title: "True Automation", description: "Not just advice—HundiAI executes. From SIP mandates to premium payments, everything runs on autopilot." },
    ...
    { icon: Sparkles, title: "Continuous Optimization", description: "As your income grows, HundiAI automatically increases investments and rebalances your portfolio." },
  ];

  return (
    <section id="why-hundiai" className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            ...
            HundiAI is designed to make wealth creation effortless and accessible.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-teal-50 border border-teal-100">
              <h4 className="font-semibold text-foreground mb-4">With HundiAI</h4>
...
export default WhyHundiAISection;
